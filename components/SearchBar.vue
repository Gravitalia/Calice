<template>
    <div>
        ...
        <div class="absolute">
            <a v-for="(element, index) of results" :key="index" :href="element._path" class="rounded-sm w-96 block px-4 py-2 text-sm text-gray-700 transition duration-150 ease-out focus:outline-none relative bg-white hover:bg-gray-50 hover:text-gray-900">
